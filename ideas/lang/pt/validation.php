...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Mensagem de Validação
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir contêm as mensagens de erro padrão usadas pela
    | classe de validação. Algumas dessas regras possuem várias versões,
    | como as regras de tamanho. Sinta-se à vontade para ajustá-las.
    |
    */
    ...
    'ascii' => 'O campo :attribute deve conter apenas caracteres ASCII de byte único.',
    ...
    'missing_with_all' => 'O campo :attribute deve estar ausente quando todos :values estiverem presentes.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute fornecido apareceu em um vazamento de dados. Por favor, escolha outro :attribute.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Mensagem Personalizadas
    |--------------------------------------------------------------------------
    |
    ...
    | uma determinada regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar o marcador de atributo por
    | algo mais amigável ao leitor, como "Endereço de E-mail" em vez de
    | "email". Isso simplesmente nos ajuda a deixar as mensagens mais claras.
    |
    */
